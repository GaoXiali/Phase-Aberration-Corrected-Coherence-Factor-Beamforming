% File: waterSoundSpeed.m
% Purpose: Water sound-speed helper used by the reconstruction demos.
% Source: k-Wave toolbox function by Bradley E. Treeby; original LGPL notice retained below.
